"""
Tests of gcages.renaming for rcmip33 variables
"""
...
cases_to_check_rcmip3 = pytest.mark.parametrize(
    "rcmip3_variable, gcages_variable",
    tuple(
        pytest.param(
            rcmip3_variable,
            gcages_variable,
        ...
        for rcmip3_variable, gcages_variable in (
            ...
            (
                "Emissions|CO2|Fossil and Industrial",
...
@cases_to_check_rcmip3
def test_convert_rcmip3_variable_to_gcages(rcmip3_variable, gcages_variable):
    assert (
        convert_variable_name(
            rcmip3_variable,
            from_convention=SupportedNamingConventions.RCMIP3,
...
@cases_to_check_rcmip3
def test_convert_rcmip3_variable_to_rcmip3(rcmip3_variable, gcages_variable):
    assert (
        convert_variable_name(
            gcages_variable,

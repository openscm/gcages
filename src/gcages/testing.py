...
# Long list generated by scripts/extract-unique-testing-scenarios.py
# from SCI scenarios, with files failing the pyiam requirements
# of climate-processor removed.
KEY_SCI_TESTING_MODEL_SCENARIOS = tuple(
    [
        ...
        ("GCAM 6.0 NGFS", "NGFS Phase 5-Low Demand"),
        ...
        ("GEM-E3 V2023", "ENGAGE-Feasibility-1000/Cost-Effective"),
        ...
        ("MESSAGE-GLOBIOM 1.0", "ADVANCE-2020-1.5°C-2100"),
        ("MESSAGE-GLOBIOM 1.0", "EMF30-BCOC-EndU"),
        ("MESSAGEix-GLOBIOM 1.0", "CD-LINKS-INDC2030i_1600"),
        ...
        ("MESSAGEix-GLOBIOM 1.1", "NGFS Phase 2-Below 2°C"),
        ...
        ("MINES 0.1.0", "China-NZP-SSP2-com"),
        ("POLES ADVANCE", "ADVANCE-2020-1.5°C-2100"),
        ("POLES GECO2019", "COMMIT-2°C-2020"),
        ("POLES-JRC ENGAGE", "ENGAGE-Feasibility-1000/Cost-Effective"),
        ("REMIND 1.6", "EMF30-BCOC-EndU"),
        ("REMIND 1.7", "ADVANCE-2020-1.5°C-2100"),
        ("REMIND 1.7", "ADVANCE-2020-medium-2°C"),
        ("REMIND 1.7", "CEMICS-1.5°C-CDR12"),
        ("REMIND 1.7", "CEMICS-Ref"),
        ("REMIND 2.1", "CEMICS-GDPgrowth-1.5°C"),
        ("REMIND 2.1", "CEMICS-GDPgrowth-2.0°C"),
        ("REMIND 2.1", "ECEMF-DIAG-C400-lin"),
        ...
        ("REMIND-MAgPIE 1.7-3.0", "EMF33-1.5°C-cost100"),
        ("REMIND-MAgPIE 3.3-4.8", "NGFS Phase 5-Below 2°C"),
        ("WITCH 4.6", "DISCRATE-Reference-dr2p"),

...
EMISSIONS_VARIABLES = pd.DataFrame(
    [
        ...
        ("Emissions|C2F6", "Emissions|C2F6", "Emissions|C2F6"),
        ("Emissions|C3F8", "Emissions|C3F8", "Emissions|C3F8"),
        ("Emissions|C4F10", "Emissions|C4F10", "Emissions|C4F10"),
        ("Emissions|C5F12", "Emissions|C5F12", "Emissions|C5F12"),
        ("Emissions|C6F14", "Emissions|C6F14", "Emissions|C6F14"),
        ("Emissions|C7F16", "Emissions|C7F16", "Emissions|C7F16"),
        ("Emissions|C8F18", "Emissions|C8F18", "Emissions|C8F18"),
        ("Emissions|CF4", "Emissions|CF4", "Emissions|CF4"),
        ...
        ("Emissions|cC4F8", "Emissions|cC4F8", "Emissions|cC4F8"),
    ],
